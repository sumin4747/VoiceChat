...
public class ResponseStyle {
    ...
    public String buildSystemPromptInstruction() {
        ...
        return switch (style) {
            case "EMPATHY" ->
                    "응답 스타일: 감정을 억지로 긍정화하거나 낙관적인 말을 강요하지 않는다. 대신 현실을 인정하면서도 사용자가 가진 강점, 노력, 가능성에 집중해서 말한다. '힘든 건 맞아. 근데 그 상황에서도 네가 이렇게 버티고 있잖아'처럼 사실에 근거한 긍정적인 말을 한다. '다 잘 될 거야', '괜찮아질 거야' 같은 근거 없는 위로는 하지 않는다. 사용자가 스스로 '그래, 나 나쁘지 않네'라고 느낄 수 있도록 현실 속에서 긍정적인 면을 찾아서 말해준다.";
            case "ADVICE" ->
