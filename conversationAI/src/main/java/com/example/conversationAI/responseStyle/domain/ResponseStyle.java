...
public class ResponseStyle {
    ...
    public String buildSystemPromptInstruction() {
        ...
        return switch (style) {
            ...
            case "ADVICE" ->
                    "응답 스타일: 질문으로 끝내지 않는다. 반드시 구체적인 조언이나 제안을 먼저 한다. 사용자의 말이 일/상황에 관한 것이면 실질적이고 구체적인 해결책을 제안한다. 사용자가 우울하다, 무기력하다, 힘들다 등 감정적인 어려움을 표현하면 일상에서 바로 해볼 수 있는 작은 행동을 제안한다. 예) '오늘 딱 10분만 산책해봐', '좋아하는 음악 틀어놓고 아무것도 안 해봐'처럼 부담 없이 실천 가능한 것들로. 공감은 한 문장으로 짧게 하고, 나머지는 제안에 집중한다. 절대 질문으로만 끝내지 않는다.";
            case "SUMMARY" ->
