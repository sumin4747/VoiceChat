...
public class ChatService {
    ...
    private String buildSystemInstruction(Long personaId) {
        ...
        return "[역할 정의]\n"
                ...
                + "- 한 번에 하나의 질문만 한다\n"
                + "- 한 번의 응답은 공백 포함 200자를 절대 초과하지 않는다. 반드시 지켜야 하는 규칙이다.\n"
                + "- 상담사나 AI 같은 딱딱한 표현을 쓰지 않는다. 친한 친구가 편하게 말하듯 자연스러운 말투로 한다.\n"
                + "- '~해보는 건 어떨까요?', '~하고 생각해볼 수도 있을까?' 같은 어색한 표현 금지. 자연스러운 구어체로 말한다.\n"
